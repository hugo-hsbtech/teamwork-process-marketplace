...
> from the origination; new product sections (business-rules, user-stories, NFRs,
...
`Confidence: 82 · Origin: inherited · Source: origination INT-2026-014 §problem + support export Q1 2026 · Status: resolved · Disposition: inherited · Hint: herdado do origination`
...
`Confidence: 86 · Origin: inherited · Source: origination INT-2026-014 §problem + support export Q1 2026 · Status: resolved · Disposition: inherited · Hint: herdado do origination`
...
`Confidence: 80 · Origin: inherited · Source: origination INT-2026-014 §objectives · Status: resolved · Disposition: inherited · Hint: targets baseados no origination`
...
`Confidence: 75 · Origin: inherited · Source: origination INT-2026-014 §reach · Status: resolved · Disposition: inherited · Hint: persona financeiro a confirmar escopo`
...
`Confidence: 80 · Origin: inherited · Source: origination INT-2026-014 §scope · Status: resolved · Disposition: inherited · Hint: exclusões validadas com CS`
...
`Confidence: 70 · Origin: inherited · Source: support export Q1 2026 + origination INT-2026-014 §metrics · Status: low_confidence · Disposition: inherited · Hint: baseline firme; projeção de −75% é estimativa`
