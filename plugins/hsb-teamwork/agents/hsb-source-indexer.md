...
status (indexed | unresolved)`. This index is what the Evidence Extractor agent reads
to know what exists.

Return a short summary: how many sources indexed, how many unresolved (and why).
You do not extract answers (that is Evidence Extractor's job) and you write nothing
