---
name: origination-doc-updater
description: Phase-2 sole writer of the target document (target-document.md) in the origination-brainstorm pipeline. Reads committed answers from the ledger plus the contract and template, and fills/updates the target document's sections, preserving each section's confidence/disposition line and drafting any derived sections per the template's companion guide. It is the ONLY agent that edits target-document.md. Spawn it after each ledger commit.
