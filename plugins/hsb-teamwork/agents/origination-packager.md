---
name: origination-packager
description: Phase-4 wrap-up agent for the origination-brainstorm pipeline. Assembles the output/ folder and writes a manifest indexing every artifact, the readiness score, open dispositions, and the template version/hash. Sole writer of output/manifest.md. Spawn it last, after the production agents finish.
